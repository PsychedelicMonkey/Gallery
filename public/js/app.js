...
/* harmony import */ var infinite_scroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! infinite-scroll */ "./node_modules/infinite-scroll/js/index.js");
/* harmony import */ var infinite_scroll__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(infinite_scroll__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _lightbox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lightbox */ "./resources/js/lightbox.js");




(infinite_scroll__WEBPACK_IMPORTED_MODULE_2___default().imagesLoaded) = (imagesloaded__WEBPACK_IMPORTED_MODULE_0___default());
var gallery = document.querySelector(".gallery");
var msnry = new (masonry_layout__WEBPACK_IMPORTED_MODULE_1___default())(gallery, {
  itemSelector: "none",
...
imagesloaded__WEBPACK_IMPORTED_MODULE_0___default()(gallery, function () {
  gallery.classList.remove("are-images-unloaded");
  msnry.options.itemSelector = ".gallery-item";
  var items = gallery.querySelectorAll(".gallery-item");
  msnry.appended(items);
});
var infScroll = new (infinite_scroll__WEBPACK_IMPORTED_MODULE_2___default())(gallery, {
  path: "?page={{#}}",
  append: ".gallery-item",
  outlayer: msnry,
  history: false
}).on("append", function (body, path, items, response) {
  _lightbox__WEBPACK_IMPORTED_MODULE_3__["default"].refresh();
});
...
var gallery = document.querySelector(".gallery");
var lightbox = (0,lightgallery__WEBPACK_IMPORTED_MODULE_0__["default"])(gallery, {
  speed: 500,
